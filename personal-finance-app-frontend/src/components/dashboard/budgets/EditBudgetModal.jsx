  ...
  return (
    <div className="edit-modal-backdrop">
      <div className="edit-modal">
        ...
        <p className='modal-description'>As your budgets change, feel free to update your spending limits.</p>
          ...
          >
            ...
            {dropdownOpen && (
              <div className="custom-dropdown__list">
                {colors.map(color => {
                  const isUsed = usedColors.includes(color.id) && color.id !== budget.color_id;
